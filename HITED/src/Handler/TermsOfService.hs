...
getTermsOfServiceR :: Handler Html
getTermsOfServiceR = do
    setLanguage "sv"
    master <- getYesod
    defaultLayout $ do
        setTitle $ toHtml $ renderMessage master [] MsgTermsOfServiceRTitle
        $(widgetFile "termsOfService")
